...
def english_number number
	...
	zillions = [['hundred', 2], ['thousand', 3], ['million', 6], ['billion', 9], ['trillion', 12], ['quadrillion', 15],
		['quintillion', 18],['sextillion', 21],['sextillion', 21],['septillion', 24],['octillion', 27],['nonillion', 30],
...
while numberofbottles -1 > -1
	puts english_number(numberofbottles).to_s + ' of beer on the wall'
	puts english_number(numberofbottles).to_s + ' bottles of beer!'
	puts 'take one down and pass it around'
	numberofbottles = numberofbottles - 1
	puts english_number(numberofbottles).to_s + ' of beers on the wall!'
